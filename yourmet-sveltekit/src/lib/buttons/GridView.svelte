...
<span class="choices" on:click={() => selectMode("grid")}>
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-grid-3x2" viewBox="0 0 16 16">
